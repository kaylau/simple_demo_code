package com.kay.demo.notification;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = (NotificationManager) getBaseContext().getSystemService(NOTIFICATION_SERVICE);

        initButtonReceiver();//注册按键广播接收者

        showNotificationIcon(getBaseContext());//显示通知
    ...
    //消息通知设置和显示
    public static void showNotificationIcon(Context context) {
